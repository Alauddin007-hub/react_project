          ...
          <div className="row justify-content-center align-items-center">
            <div className="col-lg-5">
              <div className="box_about">
                ...
                <img
                  src="assets/img/arrow_about.png"
                  alt=""
                  className="arrow_1"
                />
              </div>
          ...
          <div className="owl-carousel owl-theme carousel_centered">
            <div className="item">
              <a href="#0">
                ...
                <img src="assets/img/staff/1_carousel.jpg" alt="" />
              </a>
            </div>
            <div className="item">
              <a href="#0">
                ...
                <img src="assets/img/staff/2_carousel.jpg" alt="" />
              </a>
            </div>
            <div className="item">
              <a href="#0">
                ...
                <img src="assets/img/staff/3_carousel.jpg" alt="" />
              </a>
            </div>
            <div className="item">
              <a href="#0">
                ...
                <img src="assets/img/staff/4_carousel.jpg" alt="" />
              </a>
            </div>
            <div className="item">
              <a href="#0">
                ...
                <img src="assets/img/staff/5_carousel.jpg" alt="" />
              </a>
            </div>
          </div>
          {/* /carousel */}
