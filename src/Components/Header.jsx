          ...
          <div className="container">
            <div className="row small-gutters">
              <div className="col-xl-3 col-lg-3 d-lg-flex align-items-center">
                <div id="logo">
                  <a href="index.html"><img src="assets/img/logo.svg" alt="" width={100} height={35} /></a>
                </div>
              </div>
              <nav className="col-xl-6 col-lg-7">
                ...
                <div className="main-menu">
                  <div id="header_menu">
                    <a href="index.html"><img src="assets/img/logo_black.svg" alt="" width={100} height={35} /></a>
                        ...
                        <div className="row small-gutters">
                          ...
                          <div className="col-lg-3 d-xl-block d-lg-block d-md-none d-sm-none d-none">
                            <div className="banner_menu">
                              <a href="#0">
                                <img src="data:image/gif;base64,R0lGODlhAQABAIAAAP///wAAACH5BAEAAAAALAAAAAABAAEAAAICRAEAOw==" data-src="assets/img/banner_menu.jpg" width={400} height={550} alt="" className="img-fluid lazy" />
                              </a>
                            </div>
                          </div>
                        </div>
                        ...
                        <ul>
                          <li>
                            <a href="product-detail-1.html">
                              <figure><img src="assets/img/products/product_placeholder_square_small.jpg" data-src="assets/img/products/shoes/thumb/1.jpg" alt="" width={50} height={50} className="lazy" /></figure>
                              <strong><span>1x Armor Air x Fear</span>$90.00</strong>
                            </a>
                            <a href="#0" className="action"><i className="ti-trash" /></a>
                          </li>
                          <li>
                            <a href="product-detail-1.html">
                              <figure><img src="assets/img/products/product_placeholder_square_small.jpg" data-src="assets/img/products/shoes/thumb/2.jpg" alt="" width={50} height={50} className="lazy" /></figure>
                  ...
                  <li>
                    <div className="dropdown dropdown-access">
                      ...
                      <div className="dropdown-menu">
                        ...
                        <ul>
                          <li>
                            <a href="track-order.html"><i className="ti-truck" />Track your Order</a>
                          </li>
                          <li>
                            <a href="account.html"><i className="ti-package" />My Orders</a>
                          </li>
                          <li>
                            <a href="account.html"><i className="ti-user" />My Profile</a>
                          </li>
                          <li>
                            <a href="help.html"><i className="ti-help-alt" />Help and Faq</a>
                          </li>
                        </ul>
                      </div>
                    </div>
